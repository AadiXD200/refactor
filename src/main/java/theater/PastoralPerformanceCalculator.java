 ...
 */
public class PastoralPerformanceCalculator extends AbstractPerformanceCalculator {

    public PastoralPerformanceCalculator(Performance performance, Play play) {
